...
public class EnemyPlane1 extends FighterPlane {
    private static final String imageName = GameConstant.EnemyPlane1.IMAGE_NAME;
    private static final int imageHeight = GameConstant.EnemyPlane1.IMAGE_HEIGHT;
    private static final int horizontalVelocity = GameConstant.EnemyPlane1.HORIZONTAL_VELOCITY; 
    ...
    private static final int initialHealth = GameConstant.EnemyPlane1.INITIAL_HEALTH;
    ...
    private static final double yUpperBound = GameConstant.EnemyPlane1.Y_UPPER_BOUND;
    private static final double yLowerBound = GameConstant.EnemyPlane1.Y_LOWER_BOUND;
    private static final double xUpperBound = GameConstant.EnemyPlane1.X_UPPER_BOUND;
    private static final double xLowerBound = GameConstant.EnemyPlane1.X_LOWER_BOUND;
     ...
     */
    public EnemyPlane1(Controller controller) {
