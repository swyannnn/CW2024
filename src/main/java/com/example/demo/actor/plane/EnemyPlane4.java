 ...
 */
public class EnemyPlane4 extends FighterPlane {
    private static final String imageName = GameConstant.EnemyPlane4.IMAGE_NAME;
    private static final int imageHeight = GameConstant.EnemyPlane4.IMAGE_HEIGHT;
    private static final int horizontalVelocity = GameConstant.EnemyPlane4.HORIZONTAL_VELOCITY; 
    ...
    private static final int initialHealth = GameConstant.EnemyPlane4.INITIAL_HEALTH;
    ...
    private static final double yUpperBound = GameConstant.EnemyPlane4.Y_UPPER_BOUND;
    private static final double yLowerBound = GameConstant.EnemyPlane4.Y_LOWER_BOUND;
    private static final double xUpperBound = GameConstant.EnemyPlane4.X_UPPER_BOUND;
    private static final double xLowerBound = GameConstant.EnemyPlane4.X_LOWER_BOUND;
     ...
     */
    public EnemyPlane4(Controller controller) {
